...
namespace cepgen
{
  ...
  ArgumentsParser&
  ArgumentsParser::addArgument( const Parameter& param )
  {
    required_params_.emplace_back( param );
    return *this;
  }

  ArgumentsParser&
  ArgumentsParser::addOptionalArgument( const Parameter& param )
  {
    optional_params_.emplace_back( param );
    return *this;
  }
