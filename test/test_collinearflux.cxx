...
int main( int argc, char* argv[] )
{
  ...
  switch ( (cepgen::mode::Beam)mode ) {
    case cepgen::mode::Beam::ProtonElastic: ktflux = cepgen::KTFlux::P_Photon_Elastic; break;
    case cepgen::mode::Beam::ProtonInelastic: ktflux = cepgen::KTFlux::P_Photon_Inelastic; break;
    default:
