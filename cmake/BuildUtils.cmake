    ...
    if(ARG_SOURCES)
        ...
        if(ARG_TESTS AND CMAKE_BUILD_TESTS)
            ...
            foreach(_t ${tt})
                ...
                file(CHMOD ${bin} PERMISSIONS OWNER_EXECUTE OWNER_WRITE OWNER_READ)
                add_test(NAME ${bin} COMMAND command ${bin})
...
macro(cepgen_test_category)
    ...
    foreach(test ${tests})
        ...
        file(CHMOD ${test} PERMISSIONS OWNER_EXECUTE OWNER_WRITE OWNER_READ)
        add_test(NAME ${test} COMMAND command ${test})
        set_property(TEST ${test} PROPERTY ENVIRONMENT "CEPGEN_PATH=${PROJECT_SOURCE_DIR}")
    endforeach()
    foreach(benchmark ${benchmarks})
        message(STATUS "... added benchmark ${benchmark}")
        file(CHMOD ${benchmark} PERMISSIONS OWNER_EXECUTE OWNER_WRITE OWNER_READ)
        add_test(NAME ${benchmark} COMMAND command ${benchmark})
    endforeach()
