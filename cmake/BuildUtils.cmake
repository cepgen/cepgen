macro(cepgen_build mod_name)
    ...
    if(ARG_SOURCES)
        ...
        set(tests)
        if(ARG_TESTS)
            file(GLOB tt RELATIVE "${CMAKE_CURRENT_SOURCE_DIR}/test" "${ARG_TESTS}")
            foreach(_t ${tt})
                string(REPLACE ".cc" "" bin ${_t})
                add_executable(${bin} "test/${_t}")
        ...
        if(ARG_PROPERTY)
            ...
            foreach(_t ${tests})
                set_property(TARGET ${_t} PROPERTY ${ARG_PROPERTY})
            endforeach()
        endif()
        if(ARG_DEFINITIONS)
