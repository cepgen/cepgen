...
if(PYTHONLIBS_FOUND)
  list(APPEND CEPGEN_EXTERNAL_CORE_REQS ${PYTHON_LIBRARIES})
...
set(KMR_PATH ${PROJECT_SOURCE_DIR}/External)
file(GLOB alphas_sources ${ALPHAS_PATH}/alphaS.f)
file(GLOB kmr_f_sources ${KMR_PATH}/f_inter_kmr_fg.f)
if(alphas_sources)
  message(STATUS "alpha(s) evolution found in ${alphas_sources}")
  add_definitions(-DALPHA_S)
endif()
if(kmr_f_sources)
  message(STATUS "KMR gluon flux found in ${kmr_f_sources}")
  add_definitions(-DKMR_FLUX)
endif()
