...
if(IS_LXPLUS)
  ...
  set(PHOTOSPP_DIR "${BASE_DIR}/releases/MCGenerators/photos++/3.61-5dfcc/x86_64-centos7-gcc62-opt")
...
find_library(PHOTOSPP NAMES Photospp HINTS $ENV{PHOTOSPP_DIR} ${PHOTOSPP_DIR} PATH_SUFFIXES lib)
find_path(PHOTOSPP_INCLUDE Photos HINTS $ENV{PHOTOSPP_DIR} ${PHOTOSPP_DIR} PATH_SUFFIXES include)
