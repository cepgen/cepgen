if($ENV{HOSTNAME} MATCHES "^lxplus[0-9]+.cern.ch")
  ...
  list(INSERT CMAKE_PREFIX_PATH 0 "${BASE_DIR}/CMake/2.8.9/Linux-i386/share/cmake-2.8/Modules")
...
if(PYTHONLIBS_FOUND)
  message(STATUS "PythonLibs v${PYTHONLIBS_VERSION_STRING} found in ${PYTHON_LIBRARIES}")
