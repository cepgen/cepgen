...
namespace cepgen {
  Central2to4PhaseSpaceGenerator::Central2to4PhaseSpaceGenerator(proc::FactorisedProcess* process, const pdgids_t& ids)
      : CentralPhaseSpaceGenerator(process), particles_{ids} {}
