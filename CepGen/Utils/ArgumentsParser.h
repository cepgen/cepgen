...
namespace cepgen {
  ...
  public:
    ...
    inline const std::vector<std::string>& extra_config() const { return extra_config_; }  ///< Extra config flags
  ...
  private:
    ...
    public:
      explicit Parameter(const std::string&,
                         const std::string& = "",
                         std::string* = nullptr,
                         const std::string& = "");  ///< String parameter constructor
      explicit Parameter(const std::string&,
                         const std::string&,
                         unsigned int* = nullptr,
                         const unsigned int& = 0);  ///< Unsigned integer parameter constructor
      explicit Parameter(const std::string&,
                         const std::string&,
                         int* = nullptr,
                         const int& = 0);  ///< Integer parameter constructor
      explicit Parameter(const std::string&,
                         const std::string&,
                         bool* = nullptr,
                         const bool& = false);  ///< Boolean parameter constructor
      explicit Parameter(const std::string&,
                         const std::string&,
                         double* = nullptr,
                         const double& = -999.999);  ///< Double-precision floating point parameter constructor
      explicit Parameter(const std::string&,
                         const std::string&,
                         std::vector<std::string>* = nullptr,
                         const std::vector<std::string>& = {});  ///< Vector of strings parameter constructor
      explicit Parameter(const std::string&,
                         const std::string&,
                         std::vector<int>* = nullptr,
                         const std::vector<int>& = {});  ///< Vector of integer parameter constructor
      explicit Parameter(const std::string&,
                         const std::string&,
                         std::vector<double>* = nullptr,
                         const std::vector<double>& = {});  ///< Vector of floating point parameter constructor
      explicit Parameter(const std::string&,
                         const std::string&,
                         Limits* = nullptr,
                         const Limits& = Limits{});  ///< Vector of floating point parameter constructor
