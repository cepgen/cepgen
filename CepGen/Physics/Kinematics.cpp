...
namespace cepgen
{
  ...
  Kinematics::sqrtS() const
  {
    ...
    const double m1 = hi1 ? particleproperties::mass( hi1 ) : PDG::get().mass( incoming_beams.first .pdg );
    const double m2 = hi2 ? particleproperties::mass( hi2 ) : PDG::get().mass( incoming_beams.second.pdg );
