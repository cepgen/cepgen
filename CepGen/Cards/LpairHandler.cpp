...
namespace cepgen
{
  namespace card
  {
      ...
      hi_1_( { 0, 0 } ), hi_2_( { 0, 0 } )
    {
      ...
      params_.kinematics.incoming_beams.first.form_factors->setStructureFunctions( strfun::StructureFunctionsFactory::get().build( sf_params ) );
      params_.kinematics.incoming_beams.second.form_factors->setStructureFunctions( strfun::StructureFunctionsFactory::get().build( sf_params ) );
