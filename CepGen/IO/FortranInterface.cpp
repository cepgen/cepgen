...
extern "C"
{
  ...
  cepgen_structure_functions_( int& sfmode, double& q2, double& xbj, double& f2, double& fl )
  {
    ...
    switch ( (SF::Type)sfmode ) {
      ...
      case SF::Type::ChristyBosted: {
        sf = SF::ChristyBosted();
      } break;
      case SF::Type::CLAS: {
        sf = SF::CLAS();
      } break;
      case SF::Type::BlockDurandHa: {
        sf = SF::BlockDurandHa();
      } break;
      case SF::Type::ALLM91: {
        sf = SF::ALLM( SF::ALLM::Parameterisation::allm91() );
      } break;
      case SF::Type::ALLM97: {
        sf = SF::ALLM( SF::ALLM::Parameterisation::allm97() );
      } break;
      case SF::Type::GD07p: {
        sf = SF::ALLM( SF::ALLM::Parameterisation::gd07p() );
      } break;
      case SF::Type::GD11p: {
        sf = SF::ALLM( SF::ALLM::Parameterisation::gd11p() );
      } break;
