...
namespace cepgen {
  ...
  public:
    ...
    template <typename T>
    const ParametersList& fill(std::string key, T& value) const {
      if (has<T>(key))
        value = get<T>(key);
      return *this;
    }
  ...
  template <>
  inline bool ParametersList::has<int>(std::string key) const {
  ...
  template <>
  inline int& ParametersList::operator[]<int>(std::string key) {
    return int_values_[key];
  }
  /// Set an integer parameter value
  template <>
  inline ParametersList& ParametersList::set<int>(std::string key, const int& value) {
    int_values_[key] = value;
    return *this;
  }
  /// Check if a vector of integers parameter is handled
  template <>
  inline bool ParametersList::has<std::vector<int> >(std::string key) const {
  ...
  template <>
  inline std::vector<int>& ParametersList::operator[]<std::vector<int> >(std::string key) {
    return vec_int_values_[key];
  }
  /// Set a vector of integers parameter value
  template <>
  inline ParametersList& ParametersList::set<std::vector<int> >(std::string key, const std::vector<int>& value) {
  ...
  template <>
  inline bool ParametersList::has<bool>(std::string key) const {
    return has<int>(key);
  }
  /// Get a boolean parameter value
  template <>
  inline bool ParametersList::get<bool>(std::string key, const bool& def) const {
    return static_cast<bool>(get<int>(key, def));
  }
  /// Reference to a boolean parameter value
  template <>
  inline bool& ParametersList::operator[]<bool>(std::string key) {
    return (bool&)operator[]<int>(key);
  }
  /// Set a boolean parameter value
  template <>
  inline ParametersList& ParametersList::set<bool>(std::string key, const bool& value) {
    return set<int>(key, static_cast<bool>(value));
  }

  /// Check if a boolean parameter is handled
  template <>
  inline bool ParametersList::has<ParticleProperties>(std::string key) const {
  ...
  template <>
  inline bool ParametersList::has<double>(std::string key) const {
  ...
  template <>
  inline double& ParametersList::operator[]<double>(std::string key) {
    return dbl_values_[key];
  }
  /// Set a double floating point parameter value
  template <>
  inline ParametersList& ParametersList::set<double>(std::string key, const double& value) {
    dbl_values_[key] = value;
    return *this;
  }
  /// Check if a vector of double floating point parameter is handled
  template <>
  inline bool ParametersList::has<std::vector<double> >(std::string key) const {
  ...
  template <>
  inline std::vector<double>& ParametersList::operator[]<std::vector<double> >(std::string key) {
    return vec_dbl_values_[key];
  }
  /// Set a vector of double floating point parameter value
  template <>
  inline ParametersList& ParametersList::set<std::vector<double> >(std::string key, const std::vector<double>& value) {
  ...
  template <>
  inline bool ParametersList::has<std::string>(std::string key) const {
  ...
  template <>
  inline std::string& ParametersList::operator[]<std::string>(std::string key) {
    return str_values_[key];
  }
  /// Set a string parameter value
  template <>
  inline ParametersList& ParametersList::set<std::string>(std::string key, const std::string& value) {
    str_values_[key] = value;
    return *this;
  }
  /// Check if a vector of strings parameter is handled
  template <>
  inline bool ParametersList::has<std::vector<std::string> >(std::string key) const {
  ...
  template <>
  inline std::vector<std::string>& ParametersList::operator[]<std::vector<std::string> >(std::string key) {
    return vec_str_values_[key];
  }
  /// Set a vector of strings parameter value
  template <>
  inline ParametersList& ParametersList::set<std::vector<std::string> >(std::string key,
  ...
  template <>
  const ParametersList& ParametersList::fill<Limits>(std::string key, Limits&) const;
  /// Reference to a boundary limits parameter value
  template <>
  inline Limits& ParametersList::operator[]<Limits>(std::string key) {
    return lim_values_[key];
  }
  /// Set a boundary limits parameter value
  template <>
  inline ParametersList& ParametersList::set<Limits>(std::string key, const Limits& value) {
  ...
  template <>
  inline bool ParametersList::has<ParametersList>(std::string key) const {
    return param_values_.count(key) != 0;
  }
  ...
  template <>
  inline ParametersList& ParametersList::operator[]<ParametersList>(std::string key) {
    return param_values_[key];
  }
  /// Set a parameters list parameter value
  template <>
  inline ParametersList& ParametersList::set<ParametersList>(std::string key, const ParametersList& value) {
    param_values_[key] = value;
    return *this;
  }
  /// Check if a vector of parameters lists is handled
  template <>
  inline bool ParametersList::has<std::vector<ParametersList> >(std::string key) const {
  ...
  template <>
  inline std::vector<ParametersList>& ParametersList::operator[]<std::vector<ParametersList> >(std::string key) {
    return vec_param_values_[key];
  }
  /// Set a vector of parameters list parameter value
  template <>
  inline ParametersList& ParametersList::set<std::vector<ParametersList> >(std::string key,
