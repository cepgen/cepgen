  ...
  namespace strfun
  {
    class Shamov : public Parameterisation
    {
      ...
      private:
        ...
        static constexpr std::array<float,19> gmq_ = { {
          0.000, 0.200, 0.300, 0.400, 0.470, 0.480, 0.500, 0.600, 0.630, 0.631, 0.770, 0.780, 0.790, 0.970, 0.980, 1.150, 1.340, 1.570, 2.340 } };
        static constexpr std::array<float,19> gmv_ = { {
          3.000, 1.770, 1.380, 1.170, 0.978, 0.961, 0.964, 0.766, 0.735, 0.719, 0.570, 0.572, 0.553, 0.460, 0.446, 0.326, 0.269, 0.209, 0.102 } };
        static constexpr std::array<float,291> gp_en_ = { {
          ...
          1.710, 1.724, 1.738, 1.743, 1.751, 1.764, 1.778, 1.791, 1.804, 1.817, 1.830, 1.831, 1.843, 1.855, 1.868, 1.880, 1.893, 1.898, 1.905, 1.917,
          1.922, 1.930, 1.942, 1.954, 1.966, 1.978, 1.989, 2.001, 2.013, 2.025, 2.036, 2.041, 2.048, 2.059, 2.070, 2.082, 2.093, 2.104, 2.115, 2.117,
          2.126, 2.137, 2.148, 2.153, 2.154, 2.159, 2.170, 2.174, 2.181, 2.191, 2.202, 2.213, 2.223, 2.234, 2.238, 2.244, 2.255, 2.265, 2.275, 2.286,
          ...
          2.860, 2.868, 2.876, 2.877, 2.885, 2.893, 2.896, 2.897, 2.901, 2.909, 2.917, 2.919, 2.925, 2.933, 2.941, 2.944, 2.949, 2.957, 2.958, 2.965,
          3.032, 3.035, 3.038, 3.114, 3.130, 3.147, 3.207, 3.218, 3.253, 3.296, 3.305, 3.383, 3.389, 3.416, 3.471, 3.479, 3.540, 3.551, 3.582, 3.634,
          3.683, 3.784, 3.867, 3.868, 3.911, 3.937, 4.029, 4.087, 4.144, 4.204, 4.257, 4.282, 4.327, 4.334, 4.379, 4.396, 4.458, 4.514, 4.580, 4.581,
          4.645, 4.715, 4.773, 4.860, 4.912, 4.931, 5.001, 5.065, 5.140, 5.141, 5.213, 5.356, 5.374, 5.541, 5.623, 5.704, 5.862, 5.935, 6.665, 7.271,
          7.672, 7.733, 8.066, 8.329, 8.485, 9.125, 9.186, 9.576, 9.979, 15.10, 20.00, 30.00, 40.00, 50.00, 60.00, 70.00, 80.00, 90.00, 100.0, 120.0,
          150.0, 170.0, 200.0, 240.0, 270.0, 310.0, 350.0, 400.0, 500.0, 7000., 14000. } };
        static constexpr std::array<float,291> gp_cs_ = { {
          0.000, 0.052, 0.108, 0.175, 0.424, 0.487, 0.527, 0.478, 0.407, 0.334, 0.244, 0.225, 0.200, 0.178, 0.177, 0.187, 0.194, 0.212, 0.223, 0.233,
          ...
          0.117, 0.116, 0.114, 0.116, 0.120, 0.116, 0.118, 0.143, 0.143, 0.143, 0.143 } };
        static constexpr std::array<float,291> gp_nr_ = { {
          ...
          0.995, 0.995, 0.995, 0.995, 0.996, 0.996, 0.996, 1.000, 1.000, 1.000, 1.000 } };
    ...
    Shamov::eval( double xbj, double q2 )
    {
      ...
      if ( ( mode_ == Mode::RealAndSuriYennieNonRes
        ...
        && ( mx > sigma_grid_.boundaries()[0].second
          || rand()*1./RAND_MAX < sigma.at( 1 ) ) ) {
        // nonresonant
