...
namespace CepGen
{
  namespace SF
  {
    ...
    {
      const std::array<double,100> xval = { {
        // F1 part
        ...
        -0.28789E+00, 0.18607E+00, 0.63534E-01, 0.19790E+01, -0.56175E+00,
         0.38964E+00, 0.54883E+00, 0.22506E-01, 0.46213E+03,  0.19221E+00,
         0.19141E+01, 0.24606E+03, 0.67469E-01, 0.13501E+01,  0.12054E+00,
        -0.89360E+02, 0.20977E+00, 0.15715E+01, 0.90736E-01, -0.38495E-02,
      ...
      /*std::array<double,50> xval1( xval.begin(), xval.end()+50 ), xvalL( xval.begin()+50, xval.begin()+100 );
      for ( unsigned short i = 0; i < 50; ++i ) {
        if ( i < 11 ) xvalL[i] = xval1[i];
      }
      xvalL[42] = xval1[46];
      xvalL[43] = xval1[47];*/
