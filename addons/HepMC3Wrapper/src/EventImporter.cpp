...
using HepMC3Importer = cepgen::hepmc3::EventImporter;
using HepMC3ImporterASCII = HepMC3Importer<HepMC3::ReaderAscii>;
using HepMC3ImporterHEPEVT = HepMC3Importer<HepMC3::ReaderHEPEVT>;
...
using HepMC3ImporterHepMC2 = HepMC3Importer<HepMC3::ReaderAsciiHepMC2>;
...
using HepMC3ImporterAsciiZ = HepMC3Importer<HepMC3::ReaderGZ<HepMC3::ReaderAscii> >;
using HepMC3ImporterHEPEVTZ = HepMC3Importer<HepMC3::ReaderGZ<HepMC3::ReaderHEPEVT> >;
...
using HepMC3ImporterRoot = HepMC3Importer<HepMC3::ReaderRoot>;
using HepMC3ImporterRootTree = HepMC3Importer<HepMC3::ReaderRootTree>;
...
using HepMC3ImporterDOT = HepMC3Importer<HepMC3::ReaderDOT>;
using HepMC3ImporterRootTreeOPAL = HepMC3Importer<HepMC3::ReaderRootTreeOPAL>;
