...
namespace cepgen {
  namespace io {
    ...
    template <typename E, typename P>
    bool PhotosTauolaParticle<E, P>::checkMomentumConservation() {
      CG_WARNING("");
      return true;
    }
    ...
    template <typename E, typename P>
    void PhotosTauolaParticle<E, P>::addDaughter(P* daughter) {
      daughters_.emplace_back(daughter);
      dynamic_cast<PhotosTauolaParticle<E, P>*>(daughter)->mothers_.emplace_back(this);
    }
    ...
    template <typename E, typename P>
    std::vector<P*> PhotosTauolaEvent<E, P>::getParticleList() {
      std::vector<P*> out;
    ...
    template <typename E, typename P>
    void PhotosTauolaEvent<E, P>::print() {}

    template class PhotosTauolaEvent<Photospp::PhotosEvent, Photospp::PhotosParticle>;
  }  // namespace io
}  // namespace cepgen
