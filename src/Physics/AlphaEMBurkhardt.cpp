...
public:
  ...
  double operator()(double q) const override {
    ...
    double real_photon_vacuum_pol;
    if (q2 < 9.e-2)
      real_photon_vacuum_pol = AEM_3PI * (13.4916 + log_q2) + 0.00835 * log_1_pl_q2;
    else if (q2 < 9.)
      real_photon_vacuum_pol = AEM_3PI * (16.32 + 2. * log_q2) + 0.00238 * log1p(3.927 * q2);
    else if (q2 < 1.e4)
      real_photon_vacuum_pol = AEM_3PI * (13.4955 + 3. * log_q2) + 0.00165 + 0.00299 * log_1_pl_q2;
    else
      real_photon_vacuum_pol = AEM_3PI * (13.4955 + 3. * log_q2) + 0.00221 + 0.00293 * log_1_pl_q2;
    return constants::ALPHA_EM / (1. - real_photon_vacuum_pol);
  }
